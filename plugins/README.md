...
```
python developer/build_extension.py -c ../tk-core -p basic -e com.sg.basic.sg -o "/Users/josh/Library/Application Support/Adobe/CEP/extensions/"
```
...
```
python developer/build_extension.py -c ../tk-core -p basic -e com.sg.basic.sg -s ../ZXPSignCmd ~/Documents/certs/my_certificate.p12 my_cert_password
```
...
```
python developer/build_extension.py -c ../tk-core -p basic -e com.sg.basic.sg -s ../ZXPSignCmd ~/Documents/certs/my_certificate.p12 my_cert_password -v v0.0.1
```
...
```
> ZXPSignCmd -verify com.sg.basic.sg.zxp -certInfo
```

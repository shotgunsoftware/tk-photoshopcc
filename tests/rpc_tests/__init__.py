...
from .photoshop import TestPhotoshopRPC
...
def get_tests_by_app_id(app_id, adobe):
    ...
    :param str app_id: The runtime application id string. This will
                       be something like "PHSP" for Photoshop, or
                       "AEFT" for After Effects. See constants.js
    ...
    if app_id in ["PHSP", "PHXS"]:
        test_cases = [TestPhotoshopRPC]
